...
?>
    <style type="text/css">
        ...
        .abbreviation select.form-control {
            width: 10%;
        }
        .checkbox.reg{
            margin-left:20px;
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group abbreviation">
                    ...
                    <select required="required" name="abbreviation_option" id="abbreviation_option" class="regular-text form-control">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <input placeholder="Enter the 10 digit mobile" type="text" id="phoneno" name="phoneno"
                           class="form-control"
                           ...
                           if($phoneno=="")
                            ...
                            <a href="javascript:void(0)" id="resend" class="btnSubmit" onClick="sendOTP();">Resend.</a>                                      
                            </div>
    ...
    <div class="submit">
       ...
       <div class="row">
            <div class="col-sm-12 mb-2">
                ...
                <input type="button" id="wpum_submitVerify" name="wpum_submit" class="btn btn-primary" value="<?php echo $buttonname;?>">
            </div>
        </div>
