jQuery(document).ready(function(){
    jQuery("#wpum_submit").hide();
    jQuery('body').delegate('#wpum_submitVerify','click',function(e) 
    {
        alert("Your not Verify your mobile no.!!");
    });
    ...
    jQuery("#wpumregister_form").validate({
        rules: {
            "first_name": "required",
            "last_name":"required",
             "user_login": {
...
//below two function are commented since first and last name field removal on registration form
/*function makeid()
{
    var text = "";
...
// validate signup form on keyup and submit
jQuery("#wpumresetpassform").validate({
    rules: {
            "pass1": {
                    required: true,
                    minlength: 8
