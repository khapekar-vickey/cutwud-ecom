...
jQuery(document).ready( function($) {
  	var noImageUrl = '../wp-content/plugins/upload_media/noimage.png';
		...
		// Uploading files
    //var imgtypearr = ['image/png', 'image/jpg', 'image/jpeg'];
    var imgtypearr= [<?php echo get_option('wpum_imagetype'); ?>];
    console.log(imgtypearr);

    var LayeredH = <?php echo get_option('wpum_width'); ?>;
    var LayeredW = <?php echo get_option('wpum_height'); ?>;
     ...
     mediaUploader = wp.media({
      ...
      mediaUploader.on('select', function() {
       ...
       var imgtype = attachment.subtype;
       ...
       if(jQuery.inArray(imgtype, imgtypearr)!='-1')
               {
                  ...
                  else
                  {
                      ...
                      alert("Sorry! Please note,upload only "+imgtypearr+" type of images.");
                  }
