    ...
    switch ( $value ) {
        case 'posts':
            if ( isset($cvw_social_options['option_title_posts']) ) {
                $title = $cvw_social_options['option_title_posts'];
            }
            
            break;
        case 'products':
            if ( isset($cvw_social_options['option_title_products']) ) {
                $title = $cvw_social_options['option_title_products'];
            }
            break;
        default:
            if ( isset($cvw_social_options['option_title_shortcode']) ) {
                $title = $cvw_social_options['option_title_shortcode'];
            }
            break;
    }
    
    $links = '<div class="social-link-content"><div class="social-link-title">'.$title.'</div>';
...
if ( $cvw_social_options['option_posts'] == 'on' ) {
    add_filter( 'the_content', 'add_social_links_posts' );
}

if ( $cvw_social_options['option_products'] == 'on' ) {
