    ...
    function processMobileVerification()
    {
        switch ($_POST["action"]) {
            case "send_otp":
                ...
                //$message = "Verification code for user ".$email_idarr[0]." registration ".$otp.".\nThis code is valid for 3 min and uses only for your identity verification purpose.";
                if (!empty($email_id)){
                    ...
                    $guest = "Guest";
                    $message = "Verification code for user ".$guest." registration ".$otp.".%nThis code is valid for 3 min and uses only for your identity verification purpose.";
                }
                $headers = "From: makeospace@gmail.com.co.in" . "\r\n";
