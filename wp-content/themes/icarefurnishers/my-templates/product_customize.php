    ...
    <div class="row">
      <div class="col-md-8">
                ...
                <div class="custom-slide-img slider-container">
                    ...
                    <div class="item">
                    <div class="content">
                    <img id="slidermain_img" src="<?=$main_img?>" class="img-responsive reel">
                    </div>
                    </div>
                    </div>
                </div>
          ...
          foreach ($attr as $key => $value)
          {
                ...
                {                  
                  ...
                  if($default==1)
                  {
                    ...
                    $termlist .='<input '.$check.' data-pid="'.$porudctId.'" data-termkey="'.trim($key).'" type="radio" name="product_attr['.trim($key).'][]" class="term_list_all" id="term_list'.$term->term_id.'"  value="'.$term->slug.'" /></div></div></li>';
    ...
    <?php }//end if
      ...
      <div class="aa">
        <?php 	echo do_shortcode("[cvw_social_links]");
		  ...
		  <a href="javascript:void(0)" onclick="javascript:genericSocialShare('http://www.facebook.com/sharer.php?u=https://aglobia.com/customize/?pid=3025')">Facebook</a>
		  <a href="javascript:void(0)" onclick="javascript:genericSocialShare('http://www.linkedin.com/shareArticle?mini=true&url=https://aglobia.com/customize/?pid=3025')">LinkedIn</a>
		  <a href="javascript:void(0)" onclick="javascript:genericSocialShare('http://pinterest.com/pin/create/button/?url=https://aglobia.com/customize/?pid=3025')">Pinterest</a>
      </div>
          </div><!-- col-md-4 -->
        </div>
