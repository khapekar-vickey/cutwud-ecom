      ...
      <div class="col-md-8">
            ...
            <div class="custom-slide-img slider-container ">
                ...
                <div id="custom_prd_slider" class="slider">
					<div class="item">
						<div class="content">
							<img id="slidermain_img" src="<?=$cust_pro_normal_img_url?>" class="reel img-responsive" >
			...
			<div id="ImgzoomModal" class="modal">
				...
				<img id="zoom_slidermain_img" src="<?=$cust_pro_normal_img_url?>" class="reel img-responsive" >
			</div>
        <!--/.Carousel Wrapper-->
